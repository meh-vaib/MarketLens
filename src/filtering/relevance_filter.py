...
LEXICON: dict[str, float] = {
    # Macro
    "inflation": 1.0, "cpi": 1.0, "ppi": 0.9, "gdp": 1.0, "unemployment": 0.9,
    "jobs report": 1.0, "non-farm payroll": 1.0, "nonfarm": 1.0, "recession": 1.2,
    "stagflation": 1.2, "deflation": 0.9, "yield curve": 1.0, "monetary policy": 1.0,
    "fiscal policy": 0.8, "trade deficit": 0.7, "treasury": 0.8,
    # Central banks
    "federal reserve": 1.2, "fed ": 1.0, "fomc": 1.2, "ecb": 1.1,
    "bank of japan": 1.1, "boj": 1.0, "bank of england": 1.0, "boe": 0.8,
    "rate hike": 1.2, "rate cut": 1.2, "interest rate": 1.0, "basis point": 0.9,
    "hawkish": 1.0, "dovish": 1.0, "quantitative easing": 1.1,
    # Markets
    "stock market": 0.9, "equities": 0.9, "s&p 500": 1.0, "nasdaq": 1.0,
    "dow jones": 0.9, "ftse": 0.8, "nikkei": 0.8, "hang seng": 0.8,
    "bond yield": 1.0, "sovereign debt": 1.0, "credit spread": 0.9,
    "currency": 0.8, "forex": 0.8, "fx": 0.6, "dollar": 0.7, "euro": 0.7, "yen": 0.7,
    "commodity": 0.8, "commodities": 0.8, "oil price": 1.0, "brent": 0.9, "wti": 0.9,
    "gold": 0.8, "natural gas": 0.8, "copper": 0.7,
    "earnings": 0.9, "guidance": 0.7, "ipo": 0.8, "merger": 0.8, "acquisition": 0.8,
    "buyback": 0.7, "dividend": 0.6, "bankruptcy": 1.0,
    # Geopolitics
    "war": 1.0, "sanction": 1.0, "tariff": 1.1, "trade war": 1.2, "embargo": 0.9,
    "election": 0.8, "geopolitical": 0.9, "ceasefire": 0.8, "opec": 1.0,
    # Crypto
    "bitcoin": 0.7, "ethereum": 0.6, "crypto": 0.7, "stablecoin": 0.7,
...
NEGATIVE_LEXICON = {
    "celebrity", "kardashian", "movie review", "soccer", "football match",
    "basketball game", "fashion week", "horoscope",
}
...
class RelevanceFilter:
    ...
    def __init__(self, threshold: float = 0.35):
        ...
        self._negative = [re.compile(rf"\b{re.escape(k)}\b", re.IGNORECASE) for k in NEGATIVE_LEXICON]
